...
def drop_piece(player, board, column):
    """Changes and returns given column on the board where first move possible, returns False if move not possible
    """
...
def check_winner(board, column, player):
    """Checks if the last move was a winning move by calling the winning move check functions, returns True if yes, False if no.
    """ 
    row = check_top(board, column) 

    if check_winner_vertical(board, column, row, player) or check_winner_horizontal_right(board, column, row, player) or \
        check_winner_horizontal_left(board, column, row, player) or check_winner_up_right(board, column, row, player) or \
        check_winner_down_right(board, column, row, player) or check_winner_up_left(board, column, row, player) or \
...
def score_position(board, player):
    ...
    section = deque()
    section.append(board[-3][0])
    section.append(board[-4][1])
    section.append(board[-5][2])
    section.append(board[-6][3])
    score += evaluate(section, player)
    
    section = deque()
    section.append(board[-2][0])
    section.append(board[-3][1])
    section.append(board[-4][2])
    section.append(board[-5][3])
    section.append(board[-6][4])
    score += evaluate(section, player)

    section = deque()
    section.append(board[-1][0])
    section.append(board[-2][1])
    section.append(board[-3][2])
    section.append(board[-4][3])
    section.append(board[-5][4])
    section.append(board[-6][5])
    score += evaluate(section, player)    
        
    section = deque()
    section.append(board[-1][1])
    section.append(board[-2][2])
    section.append(board[-3][3])
    section.append(board[-4][4])
    section.append(board[-5][5])
    section.append(board[-6][6])
    score += evaluate(section, player)      
    
    section = deque()
    section.append(board[-1][2])
    section.append(board[-2][3])
    section.append(board[-3][4])
    section.append(board[-4][5])
    section.append(board[-5][6])
    score += evaluate(section, player)  
 
    section = deque()
    section.append(board[-1][3])
    section.append(board[-2][4])
    section.append(board[-3][5])
    section.append(board[-4][6])
    score += evaluate(section, player)  

    # Score diagonal, down lwft to top right
    section = deque()
    section.append(board[-3][6])
    section.append(board[-4][5])
    section.append(board[-5][4])
    section.append(board[-6][3])
    score += evaluate(section, player) 
    ...
    section = deque()
    section.append(board[-2][6])
    section.append(board[-3][5])
    section.append(board[-4][4])
    section.append(board[-5][3])
    section.append(board[-6][2])
    score += evaluate(section, player) 
    
    section = deque()
    section.append(board[-1][6])
    section.append(board[-2][5])
    section.append(board[-3][4])
    section.append(board[-4][3])
    section.append(board[-5][2])
    section.append(board[-6][1])
    score += evaluate(section, player) 
    
    section = deque()
    section.append(board[-1][5])
    section.append(board[-2][4])
    section.append(board[-3][3])
    section.append(board[-4][2])
    section.append(board[-5][1])
    section.append(board[-6][0])
    score += evaluate(section, player) 
    
    section = deque()
    section.append(board[-1][4])
    section.append(board[-2][3])
    section.append(board[-3][2])
    section.append(board[-4][1])
    section.append(board[-5][0])
    score += evaluate(section, player) 
...
def preferred_order(columns):
    """if 2,3,4 found in columns list, moves them to the front
    """
    for i in range(len(columns)):
        if columns[i] == 2:
            columns.remove(2)
            columns.appendleft(2)
        if columns[i] == 3:
            columns.remove(3)
            columns.appendleft(3)
        if columns[i] == 4:
            columns.remove(4)
            columns.appendleft(4)
    return columns